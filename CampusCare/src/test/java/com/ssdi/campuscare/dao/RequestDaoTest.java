...
public class RequestDaoTest 
{
	...
	public void testGetAllRequests() {
		...
		String sql2 = "insert into request values (1, 1, 1, 1, \"Pending\"), (2, 2, 2, 2, \"Pending\")"; 
		jt.update(sql2);
	...
	public void testGetProviderRequests() {
		...
		String sql1 = "insert into request (request_id, consumer_id, provider_id, category_id, request_status)"
				+ " values (1, 1, 1, 1, \"Pending\"), (2, 2, 1, 2, \"Pending\")"; 
		jt.update(sql1);
		
		requestDao = new RequestDao(jt);
		JSONArray requestList = requestDao.getProviderRequest(1);					  
